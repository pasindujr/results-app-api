        ...
        <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6 dark:text-white">
                    ...
                    <h2 dir="auto"><a id="user-content-about-this-api" class="anchor" aria-hidden="true"
                                      href="#about-this-api">

                        </a>About This API
                    </h2>
                    <p dir="auto">This is a simple API for get students data and relevant results on each semester.</p>
                    <h2 dir="auto"><a id="user-content-endpoints" class="anchor" aria-hidden="true" href="#endpoints">
                    ...
                    <h2 dir="auto"><a id="user-content-supported-query-parameters" class="anchor" aria-hidden="true"
                                      href="#supported-query-parameters">
                        </a>Supported Query Parameters
                    </h2>
                    <p dir="auto">Students can be filtered based on their GPA.</p>
                    <p dir="auto">Eg - <a href="http://127.0.0.1:8000/api/v1/students?gpa%5Beq%5D=2" rel="nofollow">http://127.0.0.1:8000/api/v1/students?gpa[eq]=2</a>
                        - This output the students who have a GPA of 2.</p>
                    <h3 dir="auto"><a id="user-content-supported-conditions" class="anchor" aria-hidden="true"
                                      href="#supported-conditions">
                        </a>Supported conditions
                    </h3>
                    <p dir="auto"><code>'eq' = '=',</code> <br>
                        <code>'lt' = '&lt;',</code> <br>
                        <code>'lte' = '&lt;=',</code> <br>
                        <code>'gt' = '&gt;',</code> <br>
                        <code>'gte' = '&gt;='</code></p>
